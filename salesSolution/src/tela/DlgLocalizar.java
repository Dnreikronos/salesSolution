...
public class DlgLocalizar extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(tblProdutoPesquisa);
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        if (itemPesquisa.equalsIgnoreCase("fornecedor")) {
            new FornecedorDAO().popularTabela(tblProdutoPesquisa, tfdDescricaoPesquisa.getText());
        } else if (itemPesquisa.equalsIgnoreCase("produto")) {
            new ProdutoDAO().popularTabela(tblProdutoPesquisa, tfdDescricaoPesquisa.getText());
        }
    }//GEN-LAST:event_btnPesquisarActionPerformed

    private void btnSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecionarActionPerformed
        valores = new String[tblProdutoPesquisa.getColumnCount()];
        
        for (int i = 0; i < tblProdutoPesquisa.getColumnCount(); i++) {
            valores[i] = String.valueOf(tblProdutoPesquisa.getValueAt(tblProdutoPesquisa.getSelectedRow(), i));
        }
